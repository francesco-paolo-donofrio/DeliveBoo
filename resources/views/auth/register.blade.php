                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type=""
                                        ...
                                        value="{{ old('email') }}" placeholder="Inserisci la tua e-mail" 
                                        autocomplete="email">
                                        {{-- div per contenere msg di validazione FE tramite JS --}}
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        placeholder="inserisci una password"  autocomplete="new-password">
                                        {{-- div per contenere msg di validazione FE tramite JS --}}
                            ...
                            <div class="my-3">
                                @foreach ($types as $type)
                                    <input type="checkbox" name="types[]" value="{{ $type->id }}" class="form-check-input mx-2"
